...
$(document).ready(function () {
	...
	var swiper = new Swiper(".about__cont-bot-swiper", {
        slidesPerView: 4,
        spaceBetween: 32,
        freeMode: true,
		scrollbar: {
	...
	var rangeValue = function(){
	   var newValueNo1 = elem.value * 8400;
	   var newValueNo2 = elem.value * 17000;
	   var newValueUs1 = elem.value * 17000;
	   var newValueUs2 = elem.value * 34000;
	   var newValueP = elem.value * 50000;
	   var targetNo1 = document.querySelector('.value-no-1');
	   var targetNo2 = document.querySelector('.value-no-2');
	   var targetUs1 = document.querySelector('.value-us-1');
	   var targetUs2 = document.querySelector('.value-us-2');
	   var targetP = document.querySelector('.value-p');
	   targetNo1.innerHTML = newValueNo1;
	   targetNo2.innerHTML = newValueNo2;
	   targetUs1.innerHTML = newValueUs1;
	   targetUs2.innerHTML = newValueUs2;
	   targetP.innerHTML = newValueP;
	}
